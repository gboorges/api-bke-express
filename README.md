...
npm i @prisma/client # instala o client do prisma para importação no model
npx prisma generate # lê o modelo e gera as funções que interagirão com o modelo através do client, ou seja, ele cria as classes baseadas no modelo atual
